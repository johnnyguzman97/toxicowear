...
<head>
    ...
    <title>About Us - ToxicWear</title>
...
<body>
    ...
    <main>
        <h2>About Us</h2>
        <p>ToxicWear is a streetwear brand that embraces bold statements and unique designs. Founded in 2024, our mission is to provide high-quality clothing that allows you to express yourself and stand out from the crowd. Our collections feature exclusive designs and limited-edition items, making every piece of clothing special.</p>
        <p>Join the Toxico family and be part of a community that values creativity, authenticity, and individuality.</p>
        <p>We are passionate about fashion and dedicated to delivering the best experience to our customers.</p>
    </main>
